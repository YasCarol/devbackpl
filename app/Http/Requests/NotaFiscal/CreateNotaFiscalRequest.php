...
class CreateNotaFiscalRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cnpj_remetente' => 'required|string|cnpj_valido', // valida se é string e se possui 14 digitos
            'nome_remetente' => 'required|string|max:100', // valida se é uma string e se possui no maximo 100 caracteres
            'cnpj_transportador' => 'required|string|cnpj_valido', // valida se é string e se possui 14 digitos
